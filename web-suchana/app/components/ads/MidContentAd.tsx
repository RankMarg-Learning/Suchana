...
export default function MidContentAd() {
  ...
  return (
    <div className="ad-leader" style={{ margin: "24px 0", display: 'flex', flexDirection: 'column', alignItems: 'center', overflow: "hidden" }}>
      <Script
      ...
      />
      <div className="ad-label" style={{ fontSize: "10px", color: "var(--text3)", marginBottom: "4px", width: "100%", textAlign: "left", maxWidth: "728px" }}>
        Advertisement
      </div>
      <ins
        ref={adRef}
