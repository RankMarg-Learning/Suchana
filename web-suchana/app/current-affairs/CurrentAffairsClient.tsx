...
import { Search, Loader2, ArrowRight, Newspaper, AlertCircle, X, Flame } from "lucide-react";
...
export default function CurrentAffairsClient() {
  ...
  const category = "CURRENT_AFFAIRS";
  ...
  return (
    <main className="min-h-screen">
      <div className="leaderboard-wrap" style={{ marginTop: '20px' }}>
        <LeaderboardAd id="ca-top-leaderboard" />
      </div>

      <div className="app-shell">
        <aside className="sidebar-left">
          <SidebarAd id="ca-left-ad-1" tall />
          <SidebarAd id="ca-left-ad-2" />
        </aside>
        ...
        <section className="feed-main" id="articles-feed">
          <div className="feed-header" style={{ borderBottom: '1px solid var(--border-light)', paddingBottom: '24px' }}>
            <div className="feed-title-row" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <h1 className="feed-title" style={{ fontSize: '28px' }}>Current Affairs</h1>
                <p className="feed-subtitle" style={{ fontSize: '15px' }}>Daily news and updates for your preparation.</p>
              </div>
            </div>
          ...
          {!debouncedSearch && trendingArticles.length > 0 && (
            <div className="trending-section" style={{ padding: '24px 0', borderBottom: '1px solid var(--border-light)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
                ...
                <h3 style={{ fontSize: '18px', fontWeight: '700' }}>Trending News</h3>
              </div>
          ...
          <div ref={loadMoreRef} className="load-more-trigger">
            ...
            {!hasNextPage && allArticles.length > 0 && (
              <div className="no-more-footer" style={{ textAlign: 'center', margin: '40px 0', color: 'var(--text-muted)', fontSize: '14px' }}>
                <span className="no-more-text">End of Current Affairs</span>
              </div>
            )}
          </div>
        </section>
        ...
        <aside className="sidebar-right">
          <SidebarAd id="ca-right-ad-1" />
          <SidebarAd id="ca-right-ad-2" tall />
        </aside>
      </div>
    </main>
  );
